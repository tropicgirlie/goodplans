...
export default function SettingsPanel({ open, onClose, settings, setSettings, initialTab = 'profile', onPreviewOrganizer, onCreateOrganizer, onImportIdea, importMessage }) {
