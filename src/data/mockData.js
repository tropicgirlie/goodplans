// Mock data for Amiga Planner - Dublin Edition with Mature Kinfolk/Vogue Editorial Moodboard Collages & luana.systems Architecture
...
export const INITIAL_OUTINGS = [
  {
    ...
    iconName: 'restaurant',
    image: '/images/mature_dinner.jpg',
    ...
    souvenirPhotos: [
      '/images/mature_dinner.jpg',
      '/images/mature_hero.jpg'
    ],
    comments: [
  ...
  },
  {
    ...
    iconName: 'music_note',
    image: '/images/mature_concert.jpg',
  ...
  },
  {
    ...
    handwrittenTag: 'you’re it, my person 🌿',
    stickerType: 'retreat',
    price: '€65 / person',
    attendees: [
  ...
  },
  {
    ...
    handwrittenTag: 'shelbourne tea & pamper 💕',
    stickerType: 'tea',
    price: '€55 / person',
    attendees: [
      { ...FRIENDS_DATA[1], metBefore: true, relationNote: 'Host (Aoife)' },
